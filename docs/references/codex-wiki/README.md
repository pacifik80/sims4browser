...
## Текущее место в репозитории

Эта wiki теперь хранится в:

```text
docs/references/codex-wiki/
```

и на неё стоит ссылаться из `README.md`, `docs/README.md`, `AGENT.md` и handoff-документов.
